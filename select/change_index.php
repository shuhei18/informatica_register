...
try {
    ...
    $selectedSessions = json_decode($user['lecture_time'], true);
    ...
    <div class="site-main">
        ...
        <div class="container">
            <div class="select">
                ...
                <p style="color: red; text-align: center;">※ブラウザの戻るボタンは使用しないでください。<br>※時間が重複しているセッションは登録することはできません。</p>
                <div class="logout-container">
            <button class="select-btn-3" onclick="location.href='mypage.php'">マイページに戻る</button>
        </div>
        ...
        <div class="select-schedule">
                    <table>
                        ...
                        <td class="scchedule-agenda" id="select-1" style="background-color: #fff;" rowspan="11">
                        
                        <label>
                            <input type="checkbox" name="sessions[]" id="id_check_agree_1" data-time="13:30-14:25" data-title="【データが切り拓く生成 AIの未来～Everybody’s ready for AI except your data～】&#10;【データ連係基盤の統合／拡大、データマネジメントへ】" data-hall="1st-hall" onclick="check_agree_func_1()"><label for="1">選択</label>
                        </label>
                        <div class="modal-open">
                                    <p class="schedule-time-small">13:30 - 14:25</p>
                                    
                    
                            <span class="schedule-section-title" id="title-1" style="color: #ff4d00;"><p class="kityoukouen" style="margin-top:0">【基調講演】</p><p class="kityoukouen">データが切り拓く生成 AIの未来～Everybody’s ready for AI except your data～</p><p class="kityoukouen">データ連係基盤の統合／拡大、データマネジメントへ</p></span>
                        </div>
                            <div class="modal__content js-modal" style="left: 420px; top: 0px; display: none; height: auto;">
                            ...
                            ～Everybody’s ready for AI except your data～</h2>
                                                ...
                                                <h2 class="modal-title" style="margin-top: 60px">データ連係基盤の統合／拡大、データマネジメントへ</h2>
                                ...
                                <td class="scchedule-agenda" id="select-2" style="background-color: #fff;" rowspan="5">
                                    <label>
                                    <input type="checkbox" name="sessions[]" id="id_check_agree_2" data-time="14:40-15:05" data-title="【AI時代の勝者へ：IDMCで実現するデータマネジメント】" data-hall="1st-hall" onclick="check_agree_func_2();"><label for="2">選択</label>
                                    </label>
                                    <div class="modal-open">
                                                <p class="schedule-time-small">14:40 - 15:05</p>
                                            
                                
                                                <span class="schedule-section-title" id="title-2" style="color: #ff4d00;">AI時代の勝者へ：IDMCで実現するデータマネジメント</span>
                                    </div>
                                ...
                                <td class="scchedule-agenda" id="select-3" style="background-color: #fff;" rowspan="6">
                                    <label style="display:none">
                                    <input type="checkbox" name="sessions[]" id="id_check_agree_3"
                                        data-time="14:40-15:10" data-title="【調整中】" data-hall="2nd-hall"
                                        onclick="check_agree_func_3();"><label for="3">選択</label>
                                </label>
                                    <!--   <div class="modal-open">-->
                                                <p class="schedule-time-small">14:40 – 15:10</p>
                                            
                                
                                                <span class="schedule-section-title" id="title-3" style="color: #ff4d00;">【調整中】</span>
                                <!--  </div>-->
                                <!--modal__inner    <div class="modal__content js-modal" style="left: 128.705px; top: 98px; display: none;">
                                    <div class="modal__inner">
                                        <div class="modal__box">
                                            <div class="modal-close"></div>
                                            <span class="modal-subtitle"></span>
                                            <h2 class="modal-title">講演タイトル講演タイトル</h2>
                                            <p class="modal-description">テキストテキストテキストテキストテキストテキストテキストテキスト</p>
                                            <div class="modal-member">
                                                <div class="member-table">
                                                    <div class="member-cell">
                                                        <img src="assets/images/live/img.png" class="member-image" onerror="this.src='assets/images/live/img.png'">
                                                    </div>
                                                    <div class="member-cell">
                                                        <h3>株式会社NTTデータ</h3>
                                                        <p>役職役職役職役職
                                ...
                                <td class="scchedule-agenda" id="select-4" style="background-color: #fff;" rowspan="6">
                                    <label>
                                    <input type="checkbox" name="sessions[]" id="id_check_agree_4" data-time="14:40-15:10" data-title="【DX成功のカギ！　データをスピーディーな意思決定に活かすには】" data-hall="3rd-hall" onclick="check_agree_func_4();"><label for="4">選択</label>
                                    </label>
                                    <div class="modal-open">
                                                <p class="schedule-time-small">14:40 – 15:10</p>
                                            
                                
                                                <span class="schedule-section-title" id="title-4" style="color: #ff4d00;">DX成功のカギ！　データをスピーディーな意思決定に活かすには</span>
                                    </div>
                                ...
                                <td class="scchedule-agenda" id="select-5" style="background-color: #fff;" rowspan="5">

                                    <label>
                                    <input type="checkbox" name="sessions[]" id="id_check_agree_5" data-time="15:05-15:30" data-title="【ビジネスに革新をもたらす生成AIとモダン・データマネジメント】" data-hall="1st-hall" onclick="check_agree_func_5();"><label for="5">選択</label>
                                    </label>
                                    <div class="modal-open">
                                                <p class="schedule-time-small">15:05 – 15:30</p>
                                            
                                
                                    <span class="schedule-section-title" id="title-5" style="color: #ff4d00;">ビジネスに革新をもたらす生成AIとモダン・データマネジメント</span>
                                    </div>
                                    <div class="modal__content js-modal" style="left: 420px; top: 0px; display: none;">
                                    <div class="modal__inner">
                                                    <div class="modal__box">
                                ...
                                <td class="scchedule-agenda" id="select-6" style="background-color: #fff;" rowspan="6">

                                    <label>
                                    <input type="checkbox" name="sessions[]" id="id_check_agree_6" data-time="15:25-15:55" data-title="【「データの在処」と「人」をつなぐICT基盤の現在地】" data-hall="2nd-hall" onclick="check_agree_func_6();"><label for="6">選択</label>
                                    </label>
                                    <div class="modal-open">
                                                <p class="schedule-time-small">15:25 – 15:55</p>
                                            
                                
                                    <span class="schedule-section-title" id="title-6" style="color: #ff4d00;">「データの在処」と「人」をつなぐICT基盤の現在地</span>
                                    </div>
                                ...
                                <td class="scchedule-agenda" id="select-7" style="background-color: #fff;" rowspan="6">
                                    <label>
                                    <input type="checkbox" name="sessions[]" id="id_check_agree_7" data-time="15:25-15:55" data-title="【データ活用に悩む方必見！スモールスタートで始めるデータ活用】" data-hall="3rd-hall" onclick="check_agree_func_7();"><label for="7">選択</label>
                                    </label>
                                    <div class="modal-open">
                                                <p class="schedule-time-small">15:25 – 15:55</p>
                                            
                                
                                    <span class="schedule-section-title" id="title-7" style="color: #ff4d00;">データ活用に悩む方必見！スモールスタートで始めるデータ活用</span>
                                    </div>
                                    <div class="modal__content js-modal" style="left: 130.205px; top: 198px; display: none;">
                                    <div class="modal__inner">
                                        <div class="modal__box">
                                ...
                                <td class="scchedule-agenda" id="select-8" style="background-color: #fff;" rowspan="5">
                                    <label>
                                    <input type="checkbox" name="sessions[]" id="id_check_agree_8" data-time="15:30-15:55" data-title="【データ活用の課題と最新動向｜現場で広げるデータの利活用とは】" data-hall="1st-hall" onclick="check_agree_func_8();"><label for="8">選択</label>
                                    </label>
                                    <div class="modal-open">
                                                <p class="schedule-time-small">15:30 – 15:55</p>
                                            
                                
                                    <span class="schedule-section-title" id="title-8" style="color: #ff4d00;">データ活用の課題と最新動向<br>現場で広げるデータの利活用とは</span>
                                    </div>
                                    <div class="modal__content js-modal" style="left: 420px; top: 0px; display: none;">
                                                    <div class="modal__inner">
                                                        <div class="modal__box">
                            ...
                            <td class="schedule-time">15:40</td>
                                ...
                                <td class="scchedule-agenda" id="select-9" style="background-color: #fff;" rowspan="5">
                                    <label>
                                    <input type="checkbox" name="sessions[]" id="id_check_agree_9" data-time="16:10-16:35" data-title="【データ戦略を支えるインフォマティカ・プラットフォームの全体像
                            〜ETL/ELTからマスタデータ管理、データガバナンスまで〜】" data-hall="1st-hall" onclick="check_agree_func_9();"><label for="9">選択</label>
                                    </label>
                                    <div class="modal-open">
                                                <p class="schedule-time-small">16:10 – 16:35</p>
                                            
                                
                                    <span class="schedule-section-title" id="title-9" style="color: #ff4d00;">データ戦略を支えるインフォマティカ・プラットフォームの全体像
                                ...
                                <td class="scchedule-agenda" id="select-10" style="background-color: #fff;" rowspan="9">
                                    <label>
                                    <input type="checkbox" name="sessions[]" id="id_check_agree_10" data-time="16:10-16:55" data-title="【未来を開拓するデータ流通・活用基盤「Xzilla」】" data-hall="2nd-hall" onclick="check_agree_func_10();"><label for="10">選択</label>
                                    </label>
                                    <div class="modal-open">
                                                <p class="schedule-time-small">16:10 – 16:55</p>
                                            
                                
                                    <span class="schedule-section-title" id="title-10" style="color: #ff4d00;">未来を開拓するデータ流通・活用基盤「Xzilla」</span>
                                    </div>
                                    <div class="modal__content js-modal" style="left: 128.705px; top: 98px; display: none;">
                                    <div class="modal__inner">
                                        <div class="modal__box">
                                            ...
                                            <div class="modal-member">
                                                ...
                                                <div class="member-table">
                                                    <div class="member-cell">
                                                        <img src="assets/images/live/01_kogure.png" class="member-image" onerror="this.src='assets/images/live/img.png'">
                                                    </div>
                                                    <div class="member-cell">
                                                        <h3>アルプス システム インテグレーション株式会社</h3>
                                                        <p>プロダクト&ソリューション事業部<br>ソリューションビジネス統括部<br>ソリューション推進1部<br>ソリューション1課<span>小暮 健司 氏</span></p>
                                                    </div>
                                                </div>
                                                <div class="member-table">
                                                    <div class="member-cell">
                                                    ...
                                                    <div class="member-cell">
                                                        <h3>北海道ガス株式会社</h3>
                                                        <p>デジタルトランスフォーメーション・構造改革推進部<br>情報プラットフォーム基盤管理グループ<span>齊藤 圭司 氏</span></p>
                                                    </div>
                                                </div>
                                ...
                                <td class="scchedule-agenda" id="select-11" style="background-color: #fff;" rowspan="5">
                                    <label>
                                    <input type="checkbox" name="sessions[]" id="id_check_agree_11" data-time="16:35-17:00" data-title="【Snowflake, Databricks, AWS, Microsoft, GCP...マルチクラウドで創る最強データプラットフォーム】" data-hall="1st-hall" onclick="check_agree_func_11();"><label for="11">選択</label>
                                    </label>
                                    <div class="modal-open">
                                                <p class="schedule-time-small">16:35 - 17:00</p>
                                            
                                
                                    <span class="schedule-section-title" id="title-11" style="color: #ff4d00;">Snowflake, Databricks, AWS, Microsoft, GCP...
                            ...
                            <td class="scchedule-agenda" id="select-12" style="background-color: #fff;" rowspan="4">
                                <label>
                                <input type="checkbox" name="sessions[]" id="id_check_agree_12" data-time="17:00-17:20" data-title="【SUBARU流 全社データ活用で笑顔を作る「モノづくり革新」と「価値づくり」】" data-hall="1st-hall" onclick="check_agree_func_12();"><label for="12">選択</label>
                                </label>
                                <div class="modal-open">
                                            <p class="schedule-time-small">17:00 - 17:20</p>
                                        
                            
                                <span class="schedule-section-title" id="title-12" style="color: #ff4d00;"><p class="kityoukouen" style="margin-top:0">【特別講演】<p class="kityoukouen" style="margin:5px 0 0 0">【SUBARU流 全社データ活用で笑顔を作る「モノづくり革新」と「価値づくり」</p></span>
                                </div>
                                <div class="modal__content js-modal" style="left: 420px; top: 0px; display: none;">
                                                <div class="modal__inner">
                                                    <div class="modal__box">
