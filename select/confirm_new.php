...
<body class="site drawer drawer--left">
    ...
    <div class="site-main">
        ...
        <div class="confirm-container">
            ...
            <form id="confirmForm"
                action="send_email_new.php?utm_source=<?php echo urlencode($utm_source); ?>&utm_medium=<?php echo urlencode($utm_medium); ?>&utm_campaign=<?php echo urlencode($utm_campaign); ?>"
                method="post">
        ...
        function goToProfile() {
            ...
            form.action =
                'profile_new.php?utm_source=<?php echo urlencode($utm_source); ?>&utm_medium=<?php echo urlencode($utm_medium); ?>&utm_campaign=<?php echo urlencode($utm_campaign); ?>';
            form.method = 'post';
            form.submit();
        }
        </script>
